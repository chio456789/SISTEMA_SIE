<div class="row sales layout-top-spacing">
                            ...
                            <div class="form-group">
                                <div class="connect-sorting">
                                    ...
                                    <ul class="tabs tab-pills text-center mt-2">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-dark {{ $item->estado == 'Inactivo' ? 'disabled' : '' }}"
                                            wire:click.prevent="getDetails({{$item->id}})" style="{{ $item->estado == 'Inactivo' ? 'background-color: #fd1111;' : '' }}">INGRESAR</a>
    ...
    @include('livewire.cortecaja.sales-detail')
</div>
