    ...
    <div class="col-sm-12">
        <div class="widget widget-chart-one">
            <div class="widget-heading">
                <h4 class="card-title text-center"><b>Corte de Caja Tigo Money</b></h4>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-sm-12 col-md-4 mbmobile">
                    <div class="connect-sorting bg-dark">
                        <h5 class="text-white">Transacciones totales : ${{number_format($total,2)}}</h5>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-striped mt-1">
                            ...
                            <tbody>
                                ...
                                <tr style="{{$row->estado == 'Anulada' ? 'background-color: #d97171 !important':''}}">
                                    ...
                                    <td class="text-center"><h6>{{$row->nombre}}</h6></td>
