        ...
        <ul class="menu-categories">
            <li class="menu {{request()->routeIs('tigomoney') ? 'active':''}}">
                <a href="#tigomoney" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="img">
                            <img src="{{ asset('storage/icons/tigoMoney.png') }}" alt="TigoMoney" class="img-responsive" width="50px">
                        </div>
            ...
            <li class="menu {{request()->routeIs('streaming') ? 'active':''}}">
                <a href="#streaming" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="img">
                            <img src="{{ asset('storage/icons/disney.png') }}" alt="Streaming" class="img-responsive" width="90px">
                        </div>
                        <span>STREAMING</span>
                    </div>
                </a>
    ...
    <div id="compact_submenuSidebar" class="submenu-sidebar">
            ...
            <ul class="submenu-list" data-parent-element="#app">
                ...
                <li>
                    <a href="{{url('arqueostigo')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign">
                            <line x1="12" y1="1" x2="12" y2="23"></line>
                            <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                        </svg>    
                    Arqueos Tigo</a>
        ...
        <div class="submenu" id="streaming">
            <ul class="submenu-list" data-parent-element="#app">
                ...
                <li>
                    <a href="{{url('planes')}}">
                        <img src="{{ asset('storage/icons/planes.png') }}" alt="Motivo CRUD" width="25px">
                        Planes </a>
                </li>

                <li>
                    <a href="{{url('clientesstreaming')}}">
                        <img src="{{ asset('storage/icons/clientes.png') }}" alt="Comision CRUD" width="25px">
                        Alertas Clientes Streaming </a>
                </li>

                <li>
                    <a href="{{url('promociones')}}">
                    <img src="{{ asset('storage/icons/promos.png') }}" alt="Comision CRUD" width="25px">
                    Promociones </a>
                </li>
                ...
                <li>
                    <a href="{{url('reportesstreaming')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart">
                            <path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path>
                            <path d="M22 12A10 10 0 0 0 12 2v10z"></path>
                        </svg>  
