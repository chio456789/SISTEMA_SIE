<div class="header-container fixed-top">
    <header class="header navbar navbar-expand-sm 3838" style="background: #383838;">
        ...
        <a href="javascript:void(0);" class="sidebarCollapse" data-placement="bottom">
            ...
            fill="none" style="color: #ffffff;" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
            class="feather feather-list"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3" y2="6"></line><line x1="3" y1="12" x2="3" y2="12"></line><line x1="3" y1="18" x2="3" y2="18"></line></svg></a>
        ...
        <ul class="navbar-item flex-row navbar-dropdown">
            ...
            <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ asset('storage/usuarios/' . auth()->user()->imagen) }}" alt="admin-profile" class="img-fluid">
                </a>
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown"">
                    <div class="user-profile-section" style="background: #ff7600;">
                        <div class="media mx-auto">
                            <img src="{{ asset('storage/usuarios/' . auth()->user()->imagen) }}" class="img-fluid mr-2" alt="avatar">
                            <div class="media-body">
